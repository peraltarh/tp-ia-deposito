 ...
 * 2015-11-08T20:41:33.605-03:00
 * Generated source version: 3.0.5
 * 
 */
@WebServiceClient(name = "WSInformeAuditoriaBeanService", 
                  wsdlLocation = "http://localhost:8080/TestWebMethod/WSInformeAuditoriaBean?wsdl",
                  targetNamespace = "http://ws/") 
public class WSInformeAuditoriaBeanService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://ws/", "WSInformeAuditoriaBeanService");
    public final static QName WSInformeAuditoriaBeanPort = new QName("http://ws/", "WSInformeAuditoriaBeanPort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/TestWebMethod/WSInformeAuditoriaBean?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(WSInformeAuditoriaBeanService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/TestWebMethod/WSInformeAuditoriaBean?wsdl");
        }
        WSDL_LOCATION = url;
    }
